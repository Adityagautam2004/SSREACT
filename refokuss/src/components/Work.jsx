...
function Work() {
    var images = [
        ...
        {url: "https://assets-global.website-files.com/6334198f239547d0f9cd84b3/634ef092455ce2cf591e52d1_Rainfall.png" ,top: "60%" ,left: "%" , isActive: false},
        ...
        <div className='relative max-w-screen-xl mx-auto text-center'>
            ...
            <div className='top-0 w-full h-full absolute '>
                {images.map((elem, index) => (
                    elem.isActive && (<img src={elem.url} alt="" className='absolute w-60 rounded-lg -translate-x-[50%] -translate-y-[50%] transform' 
